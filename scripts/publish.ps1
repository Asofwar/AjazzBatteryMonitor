...
Write-Output "Publishing AjazzBattery.App v1.1.0 as a single-file executable..."
...
if ($PublishedExe) {
    Copy-Item $PublishedExe.FullName -Destination "$ArtifactsDir\AjazzBatteryMonitor-win-x64-v1.1.0.exe" -Force
    # Maintain alias
    ...
    Write-Output "Published EXE to: $ArtifactsDir\AjazzBatteryMonitor-win-x64-v1.1.0.exe"
} else {
