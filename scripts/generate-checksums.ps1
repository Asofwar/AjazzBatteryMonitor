...
$files = @(
    'AjazzBatteryMonitor-win-x64-v1.3.0.exe',
    'AjazzBatteryMonitor-win-x64-v1.3.0-portable.zip',
    'AjazzBatteryMonitor-Setup-v1.3.0.exe',
    'AjazzBatteryMonitor-v1.3.0.sbom.json'
)
