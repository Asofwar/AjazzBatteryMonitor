...
$files = @(
    'AjazzBatteryMonitor-win-x64-v1.2.1.exe',
    'AjazzBatteryMonitor-win-x64-v1.2.1-portable.zip',
    'AjazzBatteryMonitor-Setup-v1.2.1.exe',
    'AjazzBatteryMonitor-v1.2.1.sbom.json'
)
